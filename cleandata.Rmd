...
mergedPA <- mergedPA %>%
  mutate(
    county = ifelse(city == "telford", "Montgomery", county),
    county = ifelse(city == "philadelphia", "Philadelphia", county),
    county = ifelse(city == "lansdale", "Montgomery", county),
    county = ifelse(city == "royersford", "Montgomery", county)
  )
mergedPA|>
  filter(is.na(county))
